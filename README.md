...
The codebase is [licensed under GNU Affero General Public License v3](./LICENSE), you have the right to exploit this source code but it must remain open-source and under the same license, thanks for your support !
